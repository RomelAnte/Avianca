...
if ( ! defined( 'ADVENTURE_TRAVELLING_THEME_BUNDLE' ) ) {
    define( 'ADVENTURE_TRAVELLING_THEME_BUNDLE', 'https://www.themespride.com/themes/wordpress-theme-bundle/' );
}
...
function adventure_travelling_get_bundle() {
	...
	?>
		<div class="wrap about-wrap">
			...
			<div class="col card">
				<h2 class="title"><?php esc_html_e( ' WordPress Theme Bundle of 65+ Themes At 15% Discount. ', 'adventure-travelling' ); ?></h2>
				<p><?php esc_html_e( 'Spring Offer Is To Get WP Bundle of 65+ Themes At 15% Discount use the coupon', 'adventure-travelling' ) ?>"<input type="text" value=" TPRIDE15 "  id="myInput">".</p>
