...
if($adventure_travelling_tp_color_option != false){
$adventure_travelling_tp_theme_css .='#slider .inner_carousel, #static-blog h3,.page-box,#theme-sidebar section  {';
